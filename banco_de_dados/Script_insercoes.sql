...
insert into filme(nome, duracao, sinopse, diretor)
values("Star Wars", '1:29', "Uma aventura espacial malucona", "George Lucas");

insert into filme(nome, duracao, sinopse, diretor)
values("Senhor dos Aneis", '2:45', "Meu precioso", "Alguém aí");
